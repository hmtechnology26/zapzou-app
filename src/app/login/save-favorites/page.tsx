...
export default function LoginSaveFavoritesPage() {
  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-[radial-gradient(circle_at_top,_rgba(48,204,54,0.16),_transparent_36%),linear-gradient(180deg,_#ffffff_0%,_#f7faf8_100%)]">
        ...
        <section className="w-full max-w-xl">
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-zinc-200/80 bg-white/95 p-6 shadow-[0_30px_90px_rgba(15,23,42,0.08)] backdrop-blur-xl md:p-8">
              ...
              <div className="mb-6 flex items-center gap-3 rounded-2xl border border-[#04193D]/20 bg-[#04193D]/10 px-4 py-4 text-center">
                <Icon icon="info" size={20} className="shrink-0 text-[#04193D]" />
                <p className="text-sm font-black uppercase tracking-wide text-zinc-800">
                  PARA SALVAR SUAS COMUNIDADES COMO FAVORITO VOCÊ PRECISA ESTAR LOGADO
                </p>
              </div>
              ...
              <button
                ...
                disabled={loading}
                className="group relative flex w-full items-center justify-center gap-3 overflow-hidden rounded-full bg-[#04193D] px-6 py-4 text-sm font-black text-white shadow-[0_20px_45px_rgba(48,204,54,0.35)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_28px_60px_rgba(48,204,54,0.42)] hover:brightness-110 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60"
              >
              ...
              <footer className="mt-8 border-t border-zinc-200/70 pt-6">
                <p className="text-center text-[11px] leading-6 text-zinc-500">
                  ...
                  <Link href="/terms" className="font-bold text-[#04193D] hover:underline">
                    Termos de Uso
                  </Link>{" "}
                  e{" "}
                  <Link href="/privacy" className="font-bold text-[#04193D] hover:underline">
