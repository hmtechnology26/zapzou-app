...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top,_rgba(48,204,54,0.16),_transparent_36%),linear-gradient(180deg,_#ffffff_0%,_#f7faf8_100%)] dark:bg-[radial-gradient(circle_at_top,_rgba(48,204,54,0.14),_transparent_36%),linear-gradient(180deg,_#080a0c_0%,_#101215_100%)]">
      ...
      <main className="mx-auto flex min-h-screen max-w-6xl items-center px-4 py-10 md:px-8">
        <section className="grid w-full gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          ...
          <div className="hidden lg:block">
            ...
            <h1 className="mt-6 max-w-xl text-6xl font-black leading-[1.02] tracking-tight text-zinc-950 dark:text-white">
              Serviços locais com confiança e velocidade.
            </h1>

            <p className="mt-6 max-w-lg text-lg leading-8 text-zinc-500 dark:text-zinc-400">
              Entre na sua conta para acessar comunidades, anunciar seus serviços e gerar novas oportunidades perto de você.
            </p>

            <div className="mt-10 grid max-w-xl grid-cols-2 gap-3">
              {/* <div className="rounded-3xl border border-zinc-200/70 bg-white p-5 shadow-[0_18px_40px_rgba(15,23,42,0.05)] dark:border-white/10 dark:bg-white/[0.03]">
                <p className="text-3xl font-black text-[#30cc36]">+1000</p>
              ...
              <div className="rounded-3xl border border-zinc-200/70 bg-white p-5 shadow-[0_18px_40px_rgba(15,23,42,0.05)] dark:border-white/10 dark:bg-white/[0.03]">
                <p className="text-3xl font-black text-[#30cc36]">24h</p>
                <p className="mt-1 text-xs font-bold uppercase tracking-[0.14em] text-zinc-400">
                  suporte
                </p>
              </div>
              ...
              <div className="rounded-3xl border border-zinc-200/70 bg-white p-5 shadow-[0_18px_40px_rgba(15,23,42,0.05)] dark:border-white/10 dark:bg-white/[0.03]">
                <p className="text-3xl font-black text-[#30cc36]">100%</p>
                <p className="mt-1 text-xs font-bold uppercase tracking-[0.14em] text-zinc-400">
                  seguro
                </p>
              </div>
  ...
  <img
    ...
    alt="Conectae"
    className="h-36 w-auto drop-shadow-[0_18px_40px_rgba(48,204,54,0.12)]"
  />
</div>
              ...
              <div className="mb-8">
                ...
                <p className="mt-3 text-sm leading-6 text-zinc-500 dark:text-zinc-400">
                  Continue com sua conta Google para acessar sua comunidade.
                </p>
              </div>
        ...
        Login rápido e seguro
              ...
              <div className="mt-8 grid grid-cols-2 gap-3">
                <div className="rounded-2xl border border-zinc-200/70 bg-zinc-50 p-4 dark:border-white/10 dark:bg-white/[0.03]">
                  <div className="mb-2 flex h-10 w-10 items-center justify-center rounded-2xl bg-[#30cc36]/10 text-[#30cc36]">
              ...
              <footer className="mt-8 border-t border-zinc-200/70 pt-6 dark:border-white/10">
                <p className="text-center text-[11px] leading-6 text-zinc-500 dark:text-zinc-400">
                  ...
                  <Link
                    href="/terms"
                    className="font-bold text-[#30cc36] hover:underline"
                  >
                    Termos de Uso
                  </Link>{' '}
                  e{' '}
