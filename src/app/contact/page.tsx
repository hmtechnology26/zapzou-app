...
export default function ContactPage() {
  ...
  const handleWhatsApp = () => {
    const message = encodeURIComponent(`Olá! Sou o ${user?.name || 'Usuário'} e preciso de suporte com a plataforma ZapZou.`);
      ...
      <main className="pt-24 px-4 max-w-2xl mx-auto space-y-8">
        <section className="bg-primary/5 border border-primary/20 rounded-[2.5rem] p-8 text-center shadow-sm">
           ...
           <button 
             ...
             className="mt-8 flex items-center justify-center gap-3 w-full bg-[#25D366] text-white py-4 px-8 rounded-2xl font-black shadow-xl shadow-emerald-500/20 active:scale-95 transition-all hover:brightness-110"
           >
